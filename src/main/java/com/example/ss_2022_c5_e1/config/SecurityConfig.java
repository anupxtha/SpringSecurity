...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
     return http.httpBasic()
             ...
             // 1. Which matcher method should you use and how  ( anyRequest(), mvnMatchers() --> recommended, antMatchers() --> Not Recommended, regexMatchers() )
...
//             .mvcMatchers("/demo").hasAnyRole("admin","client")
             .mvcMatchers("/demo").hasAnyAuthority("read","ROLE_admin")
